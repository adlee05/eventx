...
function EventTiming({ register, setValue, errors }: Props) {
  ...
  return (<>
    ...
    <FieldGroup>
      ...
      <div className="md:flex gap-20">
        ...
        {!date && <span className="text-red-500 text-sm">Select a Date</span>}
        ...
        <Field className="w-35 my-3">
          ...
          <Input
            ...
            step="1"
            defaultValue="10:30:00"
            {...register("endTime", { required: "End Time is mandatory, give the audience an estimate" })}
            className="appearance-none bg-background [&::-webkit-calendar-picker-indicator]:hidden [&::-webkit-calendar-picker-indicator]:appearance-none"
          />
        </Field>
      </div>
